...
taxa_dfs = {amplicon_type: pd.read_csv(file, index_col=0) for amplicon_type, file in zip(amplicon_types, ("taxa_16s.csv", "taxa_its.csv"))}
otu_dfs = {amplicon_type: pd.read_csv(file, index_col=0) for amplicon_type, file in zip(amplicon_types, ("otu_16s.csv", "otu_its.csv"))}
treatment_dict_CA = {
    "CCC": "Control",
    "MCC": "Mulch",
    "CGC": "Glyphosate",
